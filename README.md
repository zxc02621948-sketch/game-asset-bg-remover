...
本工具可以和 [AI 動畫圖格對齊工具](https://zxc02621948-sketch.github.io/ai-sprite-align-tool/) 搭配使用。
...
在瀏覽器支援的情況下，按下「送到動畫格對齊」會先把目前圖片暫存在本機瀏覽器，再開啟動畫格對齊工具並自動載入。
...
- 對複雜半透明材質仍可能需要手動點選補修
- 棋盤格背景若已經被烘進圖片中，工具只能估算。新版已加強灰白格殘留清除，但灰色主體或低飽和素材仍可能需要手動標記保護區
- 煙霧 / 光效模式預設較保守，會優先避免把實體物件整體打薄；若素材是純光效，可再手動提高透明強度或清除強度
